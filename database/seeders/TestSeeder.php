...
class TestSeeder extends Seeder
{
    public function createUsers()
    {
        ...
        $users = [
            ...
            ['name' => 'テストユーザ21', 'login' => 'test21', 'email' => 'test21@example.com', 'status' => UserStatus::REGISTERD, 'must_change_password' => true, ],
            ['name' => 'テストユーザ22', 'login' => 'test22', 'email' => 'test22@example.com', 'status' => UserStatus::REGISTERD, 'must_change_password' => true, ],
            ['name' => 'テストユーザ23', 'login' => 'test23', 'email' => 'test23@example.com', 'status' => UserStatus::REGISTERD, 'must_change_password' => true, ],
            ['name' => 'テストユーザ24', 'login' => 'test24', 'email' => 'test24@example.com', 'status' => UserStatus::REGISTERD, 'must_change_password' => true, ],
            ['name' => 'テストユーザ25', 'login' => 'test25', 'email' => 'test25@example.com', 'status' => UserStatus::REGISTERD, 'must_change_password' => true, ],
            ['name' => 'テストユーザ26', 'login' => 'test26', 'email' => 'test26@example.com', 'status' => UserStatus::LOCKED,    'must_change_password' => true, ],
            ['name' => 'テストユーザ27', 'login' => 'test27', 'email' => 'test27@example.com', 'status' => UserStatus::LOCKED,    'must_change_password' => true, ],
            ['name' => 'テストユーザ28', 'login' => 'test28', 'email' => 'test28@example.com', 'status' => UserStatus::LOCKED,    'must_change_password' => true, ],
            ['name' => 'テストユーザ29', 'login' => 'test29', 'email' => 'test29@example.com', 'status' => UserStatus::LOCKED,    'must_change_password' => true, ],
            ['name' => 'テストユーザ30', 'login' => 'test30', 'email' => 'test30@example.com', 'status' => UserStatus::LOCKED,    'must_change_password' => true, ],
        ];
