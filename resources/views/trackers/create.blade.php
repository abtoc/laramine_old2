    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <nav>
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ __('New Tracker') }}</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="card-body">
                    <x-alert/>
                    <form method="POST" action="{{ route_query('trackers.store') }}">
                        @csrf
                                    ...
                                    <div class="col-md-8">
                                        <select name="issue_status_id" id="issue-status-id" class="form-select" required>
                                            @foreach($issue_statuses as $issue_status)
                                                <option value="{{ $issue_status->id }}" @selected($issue_status->id == old('issue_status_id'))>{{ $issue_status->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="fields_bits[]" value="1" id="fields-bits-001" @checked(in_array(1, old('fields_bits', [1])))>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-10">
                                        <ul class="projects root">
                                            @each('trackers.create-projects', $projects, 'project')
                                        </ul>
                                    </div>
                                </div>
                            </div>
