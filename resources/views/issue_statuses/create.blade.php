        ...
        <div class="col-lg-8">
            <div class="card">
                        ...
                        <div class="flex-grow-1">
                            <nav>
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('New Status') }}</li>
                                </ol>
                            </nav>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route_query('issue_statuses.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <input type="checkbox" class="form-check-input @invalid('is_closed')" id="is-closed" name="is_closed" value="1" @checked(old('is_closed'))>
